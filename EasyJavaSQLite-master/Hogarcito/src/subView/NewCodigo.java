 ...
 * @author Steven
 */
public class NewCodigo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hola! Podemos Generar El Codigo Por Ti ");

        jButton1.setText("No volver a preguntar");
        jButton1.setEnabled(false);

        buttonGroup1.add(check1);
        check1.setText("Genera mi codigo! ");

        buttonGroup1.add(check2);
        check2.setSelected(true);
        check2.setText("Usaré Un Codigo Personal");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewCodigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewCodigo dialog = new NewCodigo(new javax.swing.JDialog(), true);
